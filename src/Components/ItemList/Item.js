...
function Item(props) {
  ...
  return (
    <div className="card">
      ...
      <NavLink className='itemNavLink' to={ stock === 0 ? '/' : `/ItemDetail/${country}/${id}/${rating}/${price}`}><button type="button" className={stock !== 0 ? "btn btn-success" : "btn btn-secondary"}> Más Info </button></NavLink>
